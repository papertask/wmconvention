...
class WPML_TM_ICL20_Migration_Status {
	...
	public function set_preferred_service_to_ICL20() {
		if ( $this->get_installer_settings() && $this->get_preferred_service() ) {
	...
	private function get_preferred_service() {
		if ( $this->get_installer_settings()
		     && isset( $this->installer_settings['repositories']['wpml']['ts_info']['preferred'] )
		     && 'clear' !== $this->installer_settings['repositories']['wpml']['ts_info']['preferred'] ) {
			return $this->installer_settings['repositories']['wpml']['ts_info']['preferred'];
		}
