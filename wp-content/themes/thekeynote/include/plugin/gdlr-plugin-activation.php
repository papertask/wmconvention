...
if( !function_exists('gdlr_register_required_plugins') ){
	function gdlr_register_required_plugins(){
		$plugins = array(
			...
			array(
				'name'     				=> 'Goodlayers Conference',
				'slug'     				=> 'gdlr-conference', 
				'version'               => '1.0.1',
				'source'   				=> GDLR_LOCAL_PATH . '/include/plugin/plugins/gdlr-conference.zip',
				'required' 				=> true,
				'force_activation' 		=> false,
				'force_deactivation' 	=> false, 
			),
			...
			array('name' => 'Newsletter', 'slug' => 'newsletter', 'required' => true),
